...
<!--@include: ../../docs/internal/02_dimension_scorer_reference.md-->

## Eight Dimensions

![Eight Dimensions](/03_eight_dimensions.svg)

## BaseDimensionScorer Interface

All dimension scorers extend `BaseDimensionScorer`. Each scorer queries ServiceNow CMDB tables, evaluates quality checks, produces a 0-100 score, and generates findings.
...
## Example Scorer: Completeness

The `CompletenessScorer` (weight: 20%) measures what percentage of CIs have required fields populated. This is a good reference implementation for building new dimension scorers.
